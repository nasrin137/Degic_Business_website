...
import {AppBar,Toolbar,Typography,IconButton,Button,Drawer,List,ListItemText,useMediaQuery} from "@mui/material"
    ...
    <>
        ...
        <Drawer anchor='left' open={open} onClose={()=>setOpen(false)}>
            <List>
                ...
                <ListItem button> <ListItemText primary='Sign up'/>
                </ListItem>
            </List>
